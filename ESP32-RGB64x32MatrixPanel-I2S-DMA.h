 ...
 */
//#define USE_ICN2038S // use icn2038s

#define R1_PIN_DEFAULT  32
#define G1_PIN_DEFAULT  22
#define B1_PIN_DEFAULT  33
#define R2_PIN_DEFAULT  25
#define G2_PIN_DEFAULT  21
#define B2_PIN_DEFAULT  26

#define A_PIN_DEFAULT   27
#define B_PIN_DEFAULT    4
#define C_PIN_DEFAULT   14
#define D_PIN_DEFAULT    2
#define E_PIN_DEFAULT   12 // IMPORTANT: Change to a valid pin if using a 64x64px panel.
          
#define LAT_PIN_DEFAULT  0
